...
@PETERCORDBOT.on(admin_cmd(pattern=r"unpack", outgoing=True))
@PETERCORDBOT.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@PETERCORDBOT.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@PETERCORDBOT.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
